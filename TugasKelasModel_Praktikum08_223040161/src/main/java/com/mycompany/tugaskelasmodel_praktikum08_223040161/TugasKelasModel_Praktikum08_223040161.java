...
public class TugasKelasModel_Praktikum08_223040161 extends JFrame {
    tableModelTugasKelasModel tableModelTugasKelasModel;
    String jenisKelamin = "";
    
    public TugasKelasModel_Praktikum08_223040161() {
        ...
        tableModelTugasKelasModel tableModelTugasKelasModel = new tableModelTugasKelasModel();
        tabel.setModel(tableModelTugasKelasModel);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!inputNama.getText().trim().isEmpty() && !inputNomorHp.getText().trim().isEmpty() && !inputAlamat.getText().trim().isEmpty() && jenisKelamin != "") {
                    ...
                    if (konfirmasiSimpanData == JOptionPane.YES_OPTION) {
                        ...
                        tableModelTugasKelasModel.add(biodata);

                        try {
                            FileWriter file = new FileWriter("src/biodata.txt");
                            file.write(
                                "---------------BIODATA---------------\n"+
                                    "Nama               :" + nama + "\n" +
        ...
        buttonDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow >= 0) {
                    tableModelTugasKelasModel.remove(selectedRow);
        ...
        buttonEdit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow >= 0) {
                    ...
                    tableModelTugasKelasModel.setValueAt(inputNama.getText(), selectedRow, 0);
                    tableModelTugasKelasModel.setValueAt(inputNomorHp.getText(), selectedRow, 1);
                    tableModelTugasKelasModel.setValueAt(jenisKelamin, selectedRow, 2);
                    tableModelTugasKelasModel.setValueAt(inputAlamat.getText(), selectedRow, 3);
        ...
        tabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                inputNama.setText(tableModelTugasKelasModel.getValueAt(selectedRow, 0).toString());
                inputNomorHp.setText(tableModelTugasKelasModel.getValueAt(selectedRow, 1).toString());
                jenisKelamin = tableModelTugasKelasModel.getValueAt(selectedRow, 2).toString();
                if (jenisKelamin.equals("Perempuan")) {
                    radioButton1.setSelected(true);
                } else {
                    radioButton2.setSelected(true);
                }
                inputAlamat.setText(tableModelTugasKelasModel.getValueAt(selectedRow, 3).toString());
            }
        });
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                TugasKelasModel_Praktikum08_223040161 h = new TugasKelasModel_Praktikum08_223040161();
                h.setVisible(true);
            }
        });
    }
